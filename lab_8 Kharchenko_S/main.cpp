...
void write_matrix(const int matrix[M][N], const int m, const int n) //записання результату у відповідний файл
{
    ofstream fout("matrix_in_30.txt");
